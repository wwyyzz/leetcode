...
public class s1Test {
    ...
    public void reverseString() {
        assertEquals("olleh", new Solution1().reverseString(new String("hello")));
        assertEquals("amanaP :lanac a ,nalp a ,nam A", new Solution1().reverseString(new String("A man, a plan, a canal: Panama")));
